...
class GameStats:
    def __init__(self, partner, question_stats, correct_tostats, incorrect_tostats):
        ...
        self.export_button = Button(self.export_dismiss_frame, text="Export",
                                    font="Arial 12 bold",
                                    command=lambda: self.export(partner, question_stats, correct_tostats, incorrect_tostats))
    ...
    def export(self, partner, question_stats, correct_tostats, incorrect_tostats):
        Export(self, question_stats, correct_tostats, incorrect_tostats)
...
class Export:
    def __init__(self, partner, question_stats, correct_tostats, incorrect_tostats):
        ...
        self.save_button = Button(self.save_cancel_frame, text="Save",
                                  ...
                                  command=partial(lambda: self.save_history(partner, question_stats, correct_tostats, incorrect_tostats)))
    ...
    def save_history(self, partner, question_stats, correct_tostats, incorrect_tostats):
